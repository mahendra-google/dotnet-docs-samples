...
public class BucketGetSoftDeletePolicyTest
{
    ...
    public void BucketGetSoftDeletePolicy()
    {
        ...
        setSoftDeletePolicy.BucketSetSoftDeletePolicy(bucketName, retentionDuration);
        ...
        int disableSoftDeleteRetentionDuration = 0;
        long disableSoftDeleteRetentionDurationInSeconds = disableSoftDeleteRetentionDuration * (24 * 60 * 60);
        ...
        disableSoftDeletePolicy.BucketDisableSoftDeletePolicy(bucketName, disableSoftDeleteRetentionDuration);
